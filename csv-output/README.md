this script save your output in one csv file and append or overwrite data.
         ...
         *TN can take start time until now in time_range.txt like this format: '2023-07-19T11:20:00Z'
         ...
         CR utc version work with __time_ranges_utc__ & time_ranges_timestamp and tz-to-utc.py for receive tehran time and convert to utc and send query, after all print csv file with tehran timestamp.
