...
for file_name in processed_files:
    try:
        ...
        # Remove extra whitespace and newline from the last line
        if unique_lines:
            last_line = unique_lines[-1].rstrip()  # Remove trailing whitespace
            if last_line == '':
                unique_lines.pop()  # Remove last blank line
...
other_script_command = f'./api-query-CR-utc10.sh {sys.argv[1]}'
